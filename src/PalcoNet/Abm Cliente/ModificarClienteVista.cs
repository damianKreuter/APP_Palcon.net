...
{
    public partial class ModificarClienteVista : Form
    {
        ABMCliente abmcliente;
        String nombre, apellido, numeroDNI, email;
        public ModificarClienteVista(ABMCliente abm)
        {
            abmcliente = abm;
            nombre = "";
            apellido = nombre;
        ...
        private void botonModificar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ModificarClienteSeleccionadoVista mod = new ModificarClienteSeleccionadoVista(userID, this);
                mod.Show();
            }
        }

        private void ModificarClienteVista_Load(object sender, EventArgs e)
        {
