...
{
    public partial class ModificarClienteSeleccionadoVista : Form
    {
        ...
        ModificarClienteVista mcli;

        public ModificarClienteSeleccionadoVista(int user, ModificarClienteVista mdvista)
        {
            mcli = mdvista;
        ...
        private void ModificarClienteSeleccionadoVista_Load(object sender, EventArgs e)
        {
            cargarDatos();
        }
